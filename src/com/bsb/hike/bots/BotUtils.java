...
public class BotUtils
{
	...
	public static Map<String, BotInfo> getDefaultHardCodedBotInfoObjects(Context context)
	{
		...
		BotInfo natasha = new BotInfo.HikeBotBuilder(HikePlatformConstants.NATASHA_MSISDN).setConvName(context.getString(R.string.natasha_bot)).setConfig(18847727).build();
	...
	public static void addDefaultBotsToDB(Context context)
	{
		...
		defaultBotEntry(HikePlatformConstants.NATASHA_MSISDN, context.getString(R.string.natasha_bot), null, HikeBitmapFactory.getBase64ForDrawable(R.drawable.natasha, context.getApplicationContext()), 18847727, true, context);
