...
public class HikeNotification
{
	...
	public void notifyFavorite(final ContactInfo contactInfo, int notificationType)
	{
		...
		final String message = context.getString(Utils.isFavToFriendsMigrationAllowed() ? R.string.add_as_favorite_notification_line : R.string.add_as_friend_notification_line);

		final String text = context.getString(Utils.isFavToFriendsMigrationAllowed() ? R.string.add_as_favorite_notification : R.string.friend_req_inline_msg_received, key);
