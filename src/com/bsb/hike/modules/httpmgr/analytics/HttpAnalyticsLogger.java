...
public class HttpAnalyticsLogger
{
	 ...
	 * @param requestAnalyticsKey
	 */
	public static void logHttpRequest(String trackId, String requestAnalyticsKey)
	{
		...
		try
		{
			metadata = getHttpLogBasicJson(trackId, requestAnalyticsKey, REQUEST_LOG_EVENT);
	 ...
	 * @param responseCode
	 */
	public static void logResponseReceived(String trackId, String requestAnalyticsKey, int responseCode)
	{
		if (TextUtils.isEmpty(trackId))
		{
			return;
		...
		try
		{
			metadata = getHttpLogBasicJson(trackId, requestAnalyticsKey, RESPONSE_LOG_EVENT);
	 ...
	 */
	private static JSONObject getHttpLogBasicJson(String trackId, String requestAnalyticsKey, int logEventStage) throws JSONException
	{
		JSONObject json = new JSONObject();
		json.put(AnalyticsConstants.TRACK_ID, trackId);
		json.put(AnalyticsConstants.EVENT_KEY, requestAnalyticsKey);
