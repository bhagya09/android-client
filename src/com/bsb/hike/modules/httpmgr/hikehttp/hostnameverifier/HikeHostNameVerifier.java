package com.bsb.hike.modules.httpmgr.hikehttp.hostnameverifier;
 ...
 */
public final class HikeHostNameVerifier implements HostnameVerifier {
 // public static final OkHostnameVerifier INSTANCE = new OkHostnameVerifier();
  ...
  public boolean verifyHostName(String hostName, X509Certificate certificate) {
    ...
    if (!hasDns) {
      ...
      String cn = new HikeDistinguishedNameParser(principal).findMostSpecific("cn");
      if (cn != null) {
