...
public class NativeBridge
{
	...
	/**
	 * Platform Version 5 Call this method to put data in cache. This will be a key-value pair. A game can have different key-value pairs in the native's cache.
	 * 
	 * @param key
	...
	/**
	 * Platform Version 5 Call this function to log analytics events.
	 * 
	 * @param isUI
	...
	/**
	 * Platform Version 5 Calling this function will initiate forward of the message to a friend or group.
	 * 
	 * @param json
	...
	/**
	 * Platform Version 5 Call this method to send a normal event.
	 * 
	 * @param messageHash
	...
	/**
	 * Platform Version 5 Call this function to send a shared message to the contacts of the user. This function when forwards the data, returns with the contact details of the
	...
	/**
	 * Platform Version 5 Call this function to get all the event messages data. The data is a stringified list that contains: "name": name of the user interacting with. This gives
	...
	/**
	 * Platform Version 5 Call this function to get all the event messages data. The data is a stringified list that contains event id, message hash and the data.
	 * <p/>
	...
	/**
	 * Platform Version 5 Call this function to get all the shared messages data. The data is a stringified list that contains event id, message hash and the data.
	 * <p/>
	 * "name": name of the user interacting with. This gives name, and if the name isn't present , then the msisdn. "platformUid": the platform user id of the user interacting
	 * with. "eventId" : the event id of the event. "h" : the unique hash of the message. Helps in determining the uniqueness of a card. "d" : the data that has been sent/received
