...
public class PlatformUtils
{
	 ...
	 * "exception_track", "fld1": "java.io.FileNotFoundException: abc", "fld2": "hikenewsv14", "platformUid": "VTBoRgRzkEkRVAu3", "networkType": "1", "app_version": "4.1.0.36",
	 * "sid": 1453620914078 } } }
	 *
	 * @param content
	 * @param errorMsg
	 */
	public static void microappReadFailedAnalytics(PlatformContentModel content, String errorMsg)
	{
		try
		{
			JSONObject json = new JSONObject();
			...
			json.put(AnalyticsConstants.LOG_FIELD_2, content.getId()); //App Name
			json.put(HikePlatformConstants.PLATFORM_USER_ID, HikeSharedPreferenceUtil.getInstance().getData(HikeMessengerApp.PLATFORM_UID_SETTING, null));
			HikeAnalyticsEvent.analyticsForNonMessagingBots(AnalyticsConstants.NON_UI_EVENT, AnalyticsConstants.DOWNLOAD_EVENT, json);
		}
		catch (JSONException e)
