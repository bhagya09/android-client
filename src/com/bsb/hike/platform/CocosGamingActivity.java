...
public class CocosGamingActivity extends Cocos2dxActivity
{
	...
	{
		String path = platform_content_dir + PlatformContentConstants.HIKE_MICRO_APPS + PlatformContentConstants.HIKE_GAMES + nonMessagingBotMetadata.getAppName() + File.separator + HikeConstants.Extras.VERSIONING_DIRECTORY_NAME + nonMessagingBotMetadata.getmAppVersionCode();
