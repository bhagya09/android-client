...
public class AppConfig
{
	...
	public static boolean DEBUG_LOGS_ENABLED = false;// Utils.isSendLogsEnabled() || BuildConfig.DEBUG;

	public static boolean SHOW_LOGS = DEBUG_LOGS_ENABLED;

	public static boolean ALLOW_STAGING_TOGGLE = false; //BuildConfig.DEBUG;
