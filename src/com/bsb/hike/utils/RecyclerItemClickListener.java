...
/**
 * Used for listening to RecyclerView item clicks. You can either implement an OnItemClickListener or extend SimpleOnItemClickListener and override its methods.
 * 
 * Licence: MIT
 * 
...
public class RecyclerItemClickListener implements RecyclerView.OnItemTouchListener
{
	...
	{
		this.gestureDetector = new GestureDetector(HikeMessengerApp.getInstance().getApplicationContext(), new GestureListener());
