 ...
 * <ul>
 * <li>{@link SQLiteDatabase#openOrCreateDatabase(String, android.database.sqlite.SQLiteDatabase.CursorFactory, DatabaseErrorHandler)}</li>
 * <li>{@link SQLiteDatabase#openDatabase(String, android.database.sqlite.SQLiteDatabase.CursorFactory, int, DatabaseErrorHandler)}</li>
 * </ul>
 ...
 */
class DefaultDatabaseErrorHandler implements DatabaseErrorHandler
{
	 ...
	 *
	 * @param dbObj
	 *            the {@link SQLiteDatabase} object representing the database on which corruption is detected.
	 */
	@Override
