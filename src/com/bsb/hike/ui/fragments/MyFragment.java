...
public class MyFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        profileImgView = (ImageView) parent.findViewById(R.id.profile_image);
        statusMood = (ImageView) parent.findViewById(R.id.status_mood);
        nameView = (TextView) parent.findViewById(R.id.name);
        statusView = (TextView) parent.findViewById(R.id.subtext);
