...
public class ShadowLayout extends RelativeLayout
{
	...
	/**
	 * The "depth" factor determines the offset distance and opacity of the shadow (shadows that are further away from the source are offset greater and are more translucent).
	 * 
	 * @param depth
	 */
	...
	/**
	 * Overriding onDraw allows us to draw shadows behind every child of this container. onDraw() is called to draw a layout's content before the children are drawn, so the shadows
