...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs) {
      ...
      //Rashmi - mQueryTextView.setOnItemClickListener(mOnItemClickListener);
      //Rashmi -mQueryTextView.setOnItemSelectedListener(mOnItemSelectedListener);
...
//        }
    ...
    public void setSuggestionsAdapter(CursorAdapter adapter) {
      ...
      //Rashmi -  mQueryTextView.setAdapter(mSuggestionsAdapter);
    }
    /**
...
//        }
    ...
    private void updateFocusedState() {
        ...
        if(mSubmitArea.getBackground()!=null)
        {
...
//        ssb.append(hintText);
//        Drawable searchIcon = getContext().getResources().getDrawable(android.R.drawable.ic_menu_search);
...
//        return ssb;
    ...
    private void updateSearchAutoComplete() {
    	//Rashmi-  mQueryTextView.setThreshold(mSearchable.getSuggestThreshold());
    ...
    private void dismissSuggestions() {
    	//Rashmi- mQueryTextView.dismissDropDown();
    }
    ...
    private void adjustDropDownSizeAndPosition() {
        if (mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = mIconifiedByDefault
                    ...
                    : 0;
                  //Rashmi- mQueryTextView.getDropDownBackground().getPadding(dropDownPadding);
            int offset = anchorPadding - (dropDownPadding.left + iconOffset);
          //Rashmi-  mQueryTextView.setDropDownHorizontalOffset(offset);
            final int width = mDropDownAnchor.getWidth() + dropDownPadding.left
                    + dropDownPadding.right + iconOffset - anchorPadding;
          //Rashmi- mQueryTextView.setDropDownWidth(width);
        }
    }
...
//        HIDDEN_METHOD_INVOKER.doAfterTextChanged(mQueryTextView);
     ...
     * @hide
     */
    public static class SearchAutoComplete extends AdaptxtEditText {
        private int mThreshold;
        private SearchView mSearchView;
        public SearchAutoComplete(Context context) {
            super(context);
            //Rashmi - mThreshold = getThreshold();
        }
...
//                	//Rashmi - HIDDEN_METHOD_INVOKER.ensureImeVisible(this, true);
//                }
//            }
//        }
        @Override
