...
public class Switch extends View implements Checkable
{
	...
	private void applyStyle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes)
	{
		...
		if (mTrackColors == null)
		{
			...
			int[] colors = new int[] { ColorUtil.getColor(ThemeUtil.colorControlNormal(context, 0xFF000000), 0.5f),
	 ...
	 * 
	 * @param listener
	 *            The {@link Switch.OnCheckedChangeListener} will be called.
	 */
	...
	private void buildShadow()
	{
		...
		mShadowPaint.setShader(new RadialGradient(0, 0, mThumbRadius + mShadowSize, new int[] { COLOR_SHADOW_START, COLOR_SHADOW_START, COLOR_SHADOW_END }, new float[] { 0f,
				startRatio, 1f }, Shader.TileMode.CLAMP));
