...
public class ToolbarRippleDrawable extends Drawable implements Animatable
{
	...
	private ToolbarRippleDrawable(int backgroundAnimDuration, int backgroundColor, int rippleType, int delayClickType, int maxTouchRadius, int touchAnimDuration, int touchColor,
			Interpolator inInterpolator, Interpolator outInterpolator)
	{
	...
	public static class Builder
	{
		...
		public ToolbarRippleDrawable build()
		{
			...
			return new ToolbarRippleDrawable(mBackgroundAnimDuration, mBackgroundColor, mRippleType, mDelayClickType, mMaxRippleRadius, mRippleAnimDuration, mRippleColor,
					mInInterpolator, mOutInterpolator);
		}
