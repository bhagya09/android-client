...
/**
 * A copy of {@link android.preference.TwoStatePreference}.<br>
 * This is copied to ensure the private methods of {@link android.preference.TwoStatePreference} are available to {@link SwitchPreferenceCompat}
 * 
 * @author piyush
 * 
 */
/**
 * Common base class for preferences that have two selectable states, persist a boolean value in SharedPreferences, and may have dependent preferences that are enabled/disabled
...
public abstract class TwoStatePreference extends Preference
{
	 ...
	 * 
	 * @return Whether dependents are disabled when this preference is on ({@code true}) or when this preference is off ({@code false}).
	 */
