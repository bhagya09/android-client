...

{
	...
	public static enum ParticipantInfoState
	{
		...
		VOIP_CALL_SUMMARY, VOIP_MISSED_CALL_OUTGOING, VOIP_MISSED_CALL_INCOMING,CHANGE_ADMIN, GC_SETTING_CHANGE,OFFLINE_CONNECTION_STATUS_CONNECTED,OFFLINE_CONNECTION_STATUS_DISCONNECTED , OFFLINE_FILE_NOT_RECEIVED;
		...
		public static ParticipantInfoState fromJSON(JSONObject obj)
		{
			...
			else if (OfflineConstants.OFFLINE_MESSAGE_CONNECTED_TYPE.equals(type))
			{
				return OFFLINE_CONNECTION_STATUS_CONNECTED;
			}
			else if(OfflineConstants.OFFLINE_MESSAGE_DISCONNECTED_TYPE.equals(type))
			{
				return OFFLINE_CONNECTION_STATUS_DISCONNECTED;
			}
