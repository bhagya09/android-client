...
public class InitiateMultiFileTransferTask extends AsyncTask<Void, Void, Void>
{
	...
	private void initiateFileTransferFromIntentData(String filePath, String fileType)
	{
		...
		else
		{
			...
			if (file.length() == 0)
			{
				FTAnalyticEvents.logDevException(FTAnalyticEvents.UPLOAD_INIT, 0, FTAnalyticEvents.UPLOAD_FILE_TASK, "init", "InitiateFileTransferFromIntentData - File length is 0.");
				return;
			}
