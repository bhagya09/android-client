...
public class HandleUtil
{
	...
	public static float getCentreFocusTargetRadius(Context context)
	{

		final float targetRadius = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 12, context.getResources().getDisplayMetrics());
		return targetRadius;
	}
	 ...
	 */
	public static Handle getPressedHandle(float x, float y, float left, float top, float right, float bottom, float targetRadius, Context context)
	{

		Handle pressedHandle = null;

		if(focusCenter() && context!=null)
		{
			targetRadius = getCentreFocusTargetRadius(context);
		}
	 ...
	 * 
	 * @return the offset as a Pair where the x-offset is the first value and the y-offset is the second value; null if the handle is null
	 */
	 ...
	 *            the y-coordinate of the touch point
	 * @param handleX
	 *            the x-coordinate of the corner handle
	 * @param handleY
	 *            the y-coordinate of the corner handle
	 * @param targetRadius
	 *            the target radius in pixels
	 ...
	 *            the y-coordinate of the touch point
	 * @param handleXStart
	 *            the left x-coordinate of the horizontal bar handle
	 * @param handleXEnd
	 *            the right x-coordinate of the horizontal bar handle
	 * @param handleY
	 *            the y-coordinate of the horizontal bar handle
	 * @param targetRadius
	 *            the target radius in pixels
	 * @return true if the touch point is in the target touch zone; false otherwise
	 */
	 ...
	 *            the y-coordinate of the touch point
	 * @param handleX
	 *            the x-coordinate of the vertical bar handle
	 * @param handleYStart
	 *            the top y-coordinate of the vertical bar handle
	 * @param handleYEnd
	 *            the bottom y-coordinate of the vertical bar handle
	 * @param targetRadius
	 *            the target radius in pixels
	 * @return true if the touch point is in the target touch zone; false otherwise
	 */
	...
	/**
	 * Determines if the cropper should focus on the center handle or the side handles. If it is a small image, focus on the center handle so the user can move it. If it is a large
	 * image, focus on the side handles so user can grab them. Corresponds to the appearance of the RuleOfThirdsGuidelines.
	 * 
