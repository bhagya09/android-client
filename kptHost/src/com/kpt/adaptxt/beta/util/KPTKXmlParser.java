...
public class KPTKXmlParser implements XmlPullParser {
	...
	private Hashtable<Object,Object> entityMap;
	private int depth;
	...
	private final void error(String desc) throws XmlPullParserException {
		...
		{
			// exception(desc);
			if(desc != null && (desc.equalsIgnoreCase("undefined prefix: stream")  ||
					(desc.equalsIgnoreCase(UNEXPECTED_EOF))))
			{
				//KPTLog.d("KeyboardView", "KXMLParser "+ desc);	
			}
			else
			{
				//KPTLog.d("KeyboardView", "KXMLParser "+ desc);	
	...
	public void setInput(Reader reader) throws XmlPullParserException {
		...
		entityMap = new Hashtable<Object,Object>();
		entityMap.put("amp", "&");
		entityMap.put("apos", "'");
		entityMap.put("gt", ">");
		entityMap.put("lt", "<");
	...
	public String getAttributeValue(String namespace, String name) {
		...
		for (int i = (attributeCount << 2) - 4; i >= 0; i -= 4) {
			if (attributes[i + 2].equalsIgnoreCase(name)
					&& (namespace == null || attributes[i].equalsIgnoreCase(namespace)))
