...
public final class SuddenJumpingTouchEventHandler {
	...
	public boolean onTouchEvent(MotionEvent me, boolean isFromMainKeyboard) {
		// If there was a sudden jump, return without processing the actual motion event.
		if (handleSuddenJumping(me)) {
			return true;
		}
		
		mIsFromMainKeyboard = isFromMainKeyboard;
		return mView.processMotionEvent(me);
	}
	
	public boolean isTouchFromMainKeyboard() {
		return mIsFromMainKeyboard;
	}
}
