 ...
 *
 */
public class KPTMergeAdapter extends BaseAdapter implements SectionIndexer {
	private ArrayList<ListAdapter> pieces=new ArrayList<ListAdapter>();

	/**
		* Stock constructor, simply chaining to the superclass.
    */
	public KPTMergeAdapter() {
		super();
	}
    ...
    */
	public void addViews(List<View> views, boolean enabled) {
		if (enabled) {
			...
			addAdapter(new KPTSackOfViewsAdapter(views));
		}
	}
    ...
    */
	...
	private static class EnabledSackAdapter extends KPTSackOfViewsAdapter {
