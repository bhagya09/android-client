...
public class KPTIMELanguageSelectionDialog {
	...
	public KPTIMELanguageSelectionDialog(AdaptxtIME adaptxtIME, Context context, IBinder windowToken, KPTLanguageSwitcher languageSwitcher,
			Handler uiHandler, int mode, ContextThemeWrapper contextThemeWrapper) {

		Context mcontext = context;
		final AdaptxtIME mAdaptxtIME = adaptxtIME;
