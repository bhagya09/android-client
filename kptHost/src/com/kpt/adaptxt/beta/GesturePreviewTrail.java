...
import com.kpt.adaptxt.beta.keyboard.GestureStrokeWithPreviewPoints;
import com.kpt.adaptxt.beta.keyboard.ResizableIntArray;
...
final class GesturePreviewTrail {
	...
	public static float mGesturePreviewTrialWidth;
	...
	static final class Params {
		...
		public Params(final Resources res) {
			
			mTrailColor = res.getColor(R.color.kpt_secondary_key_color_dk_fk);

			mTrailStartWidth = res.getDimension(R.dimen.kpt_gesture_preview_trail_start_width);
			mTrailEndWidth = res.getDimension(R.dimen.kpt_gesture_preview_trail_end_width);
			mFadeoutStartDelay = res.getInteger(R.integer.kpt_config_gesture_preview_trail_fadeout_start_delay);
			mFadeoutDuration = res.getInteger(R.integer.kpt_config_gesture_preview_trail_fadeout_duration);

			mTrailLingerDuration = mFadeoutStartDelay + mFadeoutDuration;// 300;
			mUpdateInterval = res.getInteger(R.integer.kpt_config_gesture_preview_trail_update_interval);
			
			mGesturePreviewTrialWidth = res.getDimension(R.dimen.kpt_glide_trace_width);
		}
	}
	...
	private static float getWidth(final int elapsedTime, final Params params) {
		...
		//return mGesturePreviewTrialWidth;
	}
